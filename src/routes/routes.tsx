...
export const TOOL_ROUTES: IToolRouteGroup[] = [
	{
		...
		routes:[ 
			
			{
				...
				alias: ['/zero-share/receive', 'Send Files'],
	...
	},
	{
		...
		routes: [
			...
			},
			{
				...
				icon: RetweetOutlined,
				description: 'Effortlessly convert XML to JSON. GoDevRun\' free online converter transforms your data with ease. Get clean, human-readable JSON in seconds!'
			},
			{
		...
		routes: [
			{
				...
				description: 'Instantly beautify & validate your XML code! GoDevRun\' XML Formatter makes editing & debugging XML a breeze.'
			},
			{
				label: 'XML Minifier',
				path: '/xml-minifier',
			...
			},
			{
				...
				alias: ['Base64 Parser'],
				description: 'Effortlessly encode & decode Base64 with GoDevRun! Convert text for secure data transmission.'
			},
			{
				...
				description: 'Effortlessly convert images to Base64 & vice versa. GoDevRun\' Base64 Encoder / Decoder simplifies image processing for transmission & management.'
			},
			{
				...
				icon: LinkOutlined,
				alias: ['URL Parser'],
				description: 'Decode encoded URLs or encode text for URLs with GoDevRun\' URL Encoder / Decoder. Effortlessly navigate special characters & avoid errors.'
			},
			{
				label: 'URL Parser',
				path: '/url-parser',
				...
				icon: LinkOutlined,
				alias: ['URL Decoder'],
				description: 'Uncover a URL\'s secrets. GoDevRun\' URL Parser breaks down web addresses, revealing hidden details for developers & marketers.'
			},
			{
		...
		routes: [
			{
				...
				description: 'Optimize images instantly. GoDevRun\' Image Resizer shrinks file size for blazing-fast load times and improved website SEO.'
			},
			{
				...
				description: 'Crush image size with an acceptable quality loss. GoDevRun\' Image Compressor optimizes images for faster websites & better SEO.'
			},
			{
				...
				description: 'Convert JPGs to PNGs with ease. GoDevRun\' free JPG to PNG converter offers fast, high-quality conversion to optimize your images for web use.'
			},
			{
				...
				icon: RetweetOutlined,
				alias: ['Image Picture Photo Format Converter'],
				description: 'Convert PNGs to JPGs effortlessly! GoDevRun\' free converter shrinks file size without losing quality, perfect for web optimization.'
			},
			{
				...
				icon: RetweetOutlined,
				alias: ['Image Picture Photo Format Converter'],
				description: 'Convert images effortlessly. GoDevRun\' Image Format Converter lets you switch between JPG, PNG, WEBP, GIF & more in seconds.'
			}
		]
	},
	{
		...
		routes: [
			{
				...
				description: 'Effortless color conversion. GoDevRun\' Color Converter lets you switch between HEX, RGB & HSL codes in seconds. Design with confidence!'
			},
			{
				...
				description: 'Effortlessly convert numbers between bases (binary, octal, decimal, hex) with GoDevRun\' Number Base Converter.'
			},
			{
				...
				description: 'Need a unique identifier? Generate strong, random UUIDs with GoDevRun for free. Easy to use and guaranteed uniqueness.'
			},
			{
				...
				description: 'Generate secure hashes with GoDevRun. Protect passwords & verify data integrity with various hashing algorithms.'
			},
			{
				...
				description: 'Securely hash passwords with GoDevRun\'s free Bcrypt generator & checker. Verify encrypted passwords instantly.'
			},
			{
				label: 'JWT Decoder',
				path: '/jwt-decoder',
				...
				description: 'Decode JWTs with ease. GoDevRun\' JWT Decoder cracks open JSON Web Tokens, revealing their content for streamlined debugging and analysis.'
			},
			{
				label: 'SQL Formatter',
				path: '/sql-formatter',
				...
				description: 'Unleash the power of readable queries. GoDevRun\' SQL Formatter cleans and organizes your SQL code, making it easier to understand and debug.'
			},
			{
			...
			},
			{
				...
				description: 'Unscrambling Cron? GoDevRun\' Cron Expression Parser makes scheduling tasks a breeze. Parse & validate your Cron expressions effortlessly.'
			}
		]
	}
]